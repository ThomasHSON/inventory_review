                ...
                {currentPageData.length === 0 ? (
                  ...
                  currentPageData.map((item) => (
                    <tr key={item.index} className="hover:bg-gray-50">
                      ...
                      {columnSettings.STOCK && <td className="px-4 py-3 text-sm text-gray-900">{item.STOCK != null ? item.STOCK.toLocaleString() : ''}</td>}
                      ...
                      {columnSettings.QTY && <td className="px-4 py-3 text-sm text-gray-900">{item.QTY != null ? item.QTY.toLocaleString() : ''}</td>}
